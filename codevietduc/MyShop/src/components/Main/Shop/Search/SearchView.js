            ...
            <View style={wrapper}>
                <ListView
                    ...
                    renderRow={productItem => (
                        <View style={product}>
                            <Image source={{ uri: `${url}${productItem.Imgs}` }} style={productImage} />
                            <View style={mainRight}>
                                <Text style={txtName}>{toTitleCase(productItem.name)}</Text>
                                <Text style={txtPrice}>{productItem.price}$</Text>
                                <Text style={txtMaterial}>Chất Liệu {productItem.material}</Text>
                                <View style={{ flexDirection: 'row' }} >
                                    <Text style={txtColor}>Màu {productItem.color}</Text>
                                    <View
                                        style={{
                                            height: 15,
                                            width: 15,
